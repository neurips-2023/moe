...
parser.add_argument('-wd', help='optimizer weight decay')
...
train_original_model(m, mt, k, cifar100_trainloader, cifar100_valloader, 
                     ...
                     runs=runs, temps=[[1.0]*num_epochs], num_classes=num_classes, lr=lr, wd=wd, 
